...
- Paleta neutra cálida en claro, carbón en oscuro y acento verde suave. Superficies opacas, bordes discretos, tipografía del sistema, sin gradientes ni halos. Se conservan los nombres CSS compartidos `glass-*` por compatibilidad, pero ya no aplican vidrio.
- Selección de día y navegación animadas con resorte amortiguado; agenda con entrada breve y detalles de viajes con expansión progresiva. Todas respetan movimiento reducido.
