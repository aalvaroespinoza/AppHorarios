...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "glass-panel text-ink shadow-none",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("font-bold text-lg leading-tight tracking-tight text-ink ", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("text-xs text-muted-ink font-sans", className)}
    {...props}
  />
));
